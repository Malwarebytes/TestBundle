        ...
        $rootNode
            ->children()
                ->scalarNode('doctrine_migration_test_driver')
                    ...
                    ->info('Configures which driver to use for DoctrineMigrationTestCase')
                    ->example('DropMigrate | Transactions')
                ->end()
                ->scalarNode('doctrine_schema_test_driver')
                    ->defaultValue('DropCreate')
                    ->info('Configures which driver to use for DoctrineSchemaTestCase')
                    ->example('DropCreate')
                ->end()
